run:
	docker run -d -l app=loadbalancer --name haproxy --hostname haproxy --network shrnetwork -p 15432:5432 -p 17001:7001 -v ${PWD}/conf:/etc/haproxy:ro --ip=172.21.0.200 arm64v8/haproxy-lua:0.0.1
# run:
